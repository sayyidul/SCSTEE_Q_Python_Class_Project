...
def get_operator(op):
    ...
    # tampilkan angka + operator (tidak dihapus)
    result_label.config(text=current + " " + op + " ")
...
def get_result():
    ...
    # ambil angka kedua dari teks (setelah operator)
    try:
        second_number = int(current.split(operator)[1])
    except:
        return
...
btn_subtract = Button(root, text="-", bg="blue", fg="white", width=5, height=2, command=lambda: get_operator("-"))
...
btn_multiply = Button(root, text="x", bg="blue", fg="white", width=5, height=2, command=lambda: get_operator("*"))
btn_multiply.grid(row=3, column=3)
btn_multiply.config(font=("verdana", 14))

btn_clr = Button(root, text="C", bg="blue", fg="white", width=5, height=2, command=clear)
...
btn_equals = Button(root, text="=", bg="blue", fg="white", width=5, height=2, command=get_result)
